    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand site-id" href="<?php echo base_url('clientes');?>">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown <?php echo  $segmento == "veiculos" ? "active" : "" ?>">
              ...
              <ul class="dropdown-menu">
                    ...
                    <li><a href="<?php echo base_url('veiculos');?>">Veiculos</a></li>
                    ...
                    <li><a href="<?php echo base_url('abastecimentos/imprimir_abastecimentos');?>">Imprimir Lista de Abastecimentos</a></li>
                    <li><a href="<?php echo base_url('servicos/imprimir_servicos');?>">Imprimir Lista de Servicos</a></li>
