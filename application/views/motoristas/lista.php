...
<div class='row'>
    ...
    <button type="button" class="btn btn-success button-adicionar" onclick="location.href='<?=base_url('motoristas/criar')?>'">Adicionar Motorista</button>
	<?=form_close();?>
</div>
