...
<div class='row'>
	<?=form_open('clientes/salvar', array('role' => 'form'));?>
	  ...
	  <div class="form-group <?php echo form_error('cnpj') != '' ? 'has-error' : '' ?>">
	    ...
	    <input type="text" class="form-control" id="cnpj" name="cnpj" placeholder="" value="<?php echo set_value('cnpj'); ?>" />
	  </div>
	  ...
	  <div class="form-group <?php echo form_error('ddd_telefone') != '' || form_error('telefone') != '' ? 'has-error' : '' ?>">
	    ...
	    <input type="text" class="form-control ddd-telefone" id="ddd_telefone" name="ddd_telefone" placeholder="DD" value="<?php echo set_value('ddd_telefone'); ?>" />
	  ...
	  <div class="form-group <?php echo form_error('ddd_fax') != '' || form_error('fax') != '' ? 'has-error' : '' ?>">
	    ...
	    <input type="text" class="form-control ddd-telefone" id="ddd_fax" name="ddd_fax" placeholder="DD" value="<?php echo set_value('ddd_fax'); ?>" />
