...
<div class='row'>
	<h3>Exclus&atilde;o de Usu&aacute;rio</h3>
</div>
...
<div class='row'>
	<div class="form-group">
  	...
  	<div class="form-group">
    	...
    	<span><?=$usuario->data_ultimo_login?></span>
  	</div>

  	<a href="<?=base_url("usuarios/apagar/" . $usuario->id);?>" type="submit" class="btn btn-danger button-delete">Excluir</a>
